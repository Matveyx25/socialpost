...
const AdminPanel = () => (
  <Admin dataProvider={dataProvider} basename="/admin" layout={MyLayout}>
    ...
    <Resource name="campaigns/clients?isSelfPromoted=true" list={AdvertiserClientsList} edit={AdvertiserClientsTabs} options={{ label: 'Клиенты' }} icon={IconClipboardList}/>
    <Resource name="campaigns/clients?isSelfPromoted=false" list={AdvertiserContrAgentList} edit={AdvertiserClientsTabs} options={{ label: 'Контрагенты' }} icon={IconContrast}/>
