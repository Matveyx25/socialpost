...
const AdminPanel = () => (
  <Admin dataProvider={dataProvider} basename="/admin" layout={MyLayout}>
    ...
    <Resource name="campaigns/clients" options={{ label: 'Active Clients' }} list={AdvertiserClientsList} edit={AdvertiserClientsTabs} options={{ label: 'Клиенты' }} icon={IconClipboardList}/>
    <Resource name="campaigns/clients" options={{ label: 'Inactive Clients' }}  list={AdvertiserContrAgentList} edit={AdvertiserClientsTabs} options={{ label: 'Контрагенты' }} icon={IconContrast}/>
