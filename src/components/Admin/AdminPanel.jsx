...
const AdminPanel = () => (
  <Admin dataProvider={dataProvider} basename="/admin" layout={MyLayout}>
    ...
    <Resource name="campaigns/clients?isSelfPromoted=true" list={AdvertiserContrAgentList} edit={AdvertiserClientsTabs} options={{ label: 'Контрагенты' }} icon={IconContrast}/>
