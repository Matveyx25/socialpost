...
const renderInn = (record) => {
  return (
    <TextInput
      source={
        record?.agencyInfo ? "agencyInfo.advertiserInn" : "advertiserInfo.inn"
      }
      label="ИНН"
      fullWidth
    />
...
const renderPhone = (record) => {
  return (
    <TextInput
      source={
        record?.agencyInfo
          ? "agencyInfo.advertiserPhone"
          : "advertiserInfo.phone"
      }
      label="Телефон"
      fullWidth
    />
...
const renderType = (record) => {
  return (
    <SelectInput
      label="Тип"
      source={
        record?.agencyInfo ? "agencyInfo.advertiserType" : "advertiserInfo.type"
      }
      choices={[
