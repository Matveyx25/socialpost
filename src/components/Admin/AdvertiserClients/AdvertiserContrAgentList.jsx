...
export const AdvertiserContrAgentList = (props) => (
  <List {...props} exporter={false} resource={'campaigns/clients'} filter={{isSelfPromoted: true, role: 'AGENCY'}} empty={<CustomEmpty message={'Клиентов нет'}/>} pagination={<PostPagination/>}>
