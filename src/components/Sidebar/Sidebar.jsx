...
import { IconBuildingBank, IconDashboard, IconHelp, IconLifebuoy, IconList, IconMoneybag, IconPointerQuestion } from '@tabler/icons-react'
	...
	return (
		<div className={s.wrapper}>
			...
			<div className={s.itemList}>
				<SidebarItem label="Дашборд" icon={<IconDashboard/>} to={'/dashboard/'}/>
				...
				<SidebarItem label="Поддержка" icon={<IconLifebuoy/>} to={'/dashboard/support'}/>
			</div>
		</div>
	)
}
