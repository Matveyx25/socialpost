	...
	return (
		<div className='container'>
			<div className={s.wrapper}>
				...
				7.3. С согласия Пользователя Компания передает персональные данные Пользователя третьим лицам для целей приема и осуществления платежей: Кошелек Пользователю вознаграждения, а также расчета и уплаты налогов (если применимо), пополнение баланса личного кабинета. <br/>
